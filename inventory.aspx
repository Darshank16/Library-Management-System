<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="inventory.aspx.cs" Inherits="LibraryManagement.inventory" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img src="bookinventory/books1.png" id="img" width="150px" height="150px" />
                            <asp:Label ID="lbl1"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-9">
                        <label runat="server">Book Name</label>
                        <div class="form-group">
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:elibraryDBConnectionString2 %>" SelectCommand="SELECT * FROM [book_info]"></asp:SqlDataSource>
                     <div class="col">
                                    ...
                                    <ItemTemplate>
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2">
                                                    <asp:Image CssClass="img-fluid" ID="img1" runat="server" ImageUrl='<%# Eval("book_img_link") %>' />
                                                </div>
                                            </div>
                                        </div>
                                    </ItemTemplate>
